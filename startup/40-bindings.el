...
;; back my favorite isearch style
...
(define-key me-minor-mode-map ergoemacs-isearch-backward-key 'isearch-backward)
;;; jump between windows
(define-key me-minor-mode-map (kbd "C-M-<right>") 'move-cursor-next-pane)
(define-key me-minor-mode-map (kbd "C-M-<left>") 'move-cursor-previous-pane)
;; other
